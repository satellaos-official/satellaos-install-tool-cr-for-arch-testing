...
run_step "04" "yay"                             "bash    $Base/yay/run.sh"
run_step "05" "flatpak"                         "bash    $Base/flatpak/run.sh"
run_step "06" "core"                            "bash    $Base/core/run.sh"
run_step "07" "update-os-release"               "bash    $Base/update-os-release/run.sh"
run_step "08" "grub-settings"                   "bash    $Base/grub-settings/run.sh"
run_step "09" "lightdm-settings"                "bash    $Base/lightdm-settings/run.sh"
run_step "10" "themes"                          "bash    $Base/themes/run.sh"
run_step "11" "grub-theme"                      "bash    $Base/grub-theme/run.sh"
run_step "12" "pictures"                        "bash    $Base/pictures/run.sh"
run_step "13" "user-configuration-settings"     "bash    $Base/user-configuration-settings/run.sh"
run_step "14" "skel-configuration-settings"     "bash    $Base/skel-configuration-settings/run.sh"
